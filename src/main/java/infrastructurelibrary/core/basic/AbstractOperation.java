...
import infrastructurelibrary.core.abstractions.typedelements.Type;
...
public abstract class AbstractOperation implements Operation {
  ...
  protected Collection< Parameter > ownedParameter;

  protected Collection< Type > raisedException;
